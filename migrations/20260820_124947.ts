...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_orders_fulfillment_status" AS ENUM('processing', 'dispatched', 'delivered', 'cancelled');
  ...
  CREATE TABLE "orders" (
  	...
  	"fulfillment_status" "enum_orders_fulfillment_status" DEFAULT 'processing',
  	"notes" varchar,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
